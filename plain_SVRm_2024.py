...
def plain_SVRm_2024(data_directory, results_directory, args, log_file, max_iter, config, test_size, base_names, repetitions):
    ...
    for base_name in base_names:
        ...
        if base_name in processed_datasets.keys():
            ...
            base_results_directory = os.path.join(results_directory, 'plainSVRm_2024')
...
if __name__ =="__main__":
    ...
    parser.add_argument('--kernel', type=str, nargs='+',default=['rbf'], choices=['linear', 'rbf', 'sigmoid', 'poly'], required=True, help="SVM kernel type.")
    ...
    parser.add_argument('--tol', type=float, nargs='+', default=[0.0001], help="Tolerance for stopping criterion.")
