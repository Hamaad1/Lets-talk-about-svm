# this code is working, and it is taking static configuration as config_name for getting the best parameters. However getBestParams_cmd_individual.py is dynamic
...
base_names = ['DSI2','MAN2']#'DSI1', 'DSI2', 'LIB1', 'LIB2', 'MAN2']
...
def find_best_configurations(base_path, base_names, repetitions, config_name=None):
    ...
    for base_name in base_names:
        ...
        expected_parameters = []
        ###################################################uncommenting these 3 line and the 2 lines at the end of iff condition and comment the with os.scandir. 
        # then it iwll take a lot of time to make the list of directories
